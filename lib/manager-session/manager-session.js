...
class ManagerSession {
    ...
    /**
     * upgrade last update at of session data
     */
    onSaveSession() {
     ...
     * @description if auto persist session before end request
     */
    get autoSave() {
    ...
    set autoSave(autoSave) {
        if( typeof autoSave !== "boolean") {
            ...
            autoSave = ManagerSession.DEFAULT_AUTO_SAVE;
        }
